...
def continual_edit_wise(model, tokenizer, items_list, hparams, loc_data, initial_loc_index, apply_algo, edit_freq,datatype, test_generation=False):
    current_model = model
    all_metrics = []
    current_training_times = []
    edited_items = []
...
def continual_edit(model, tokenizer, items_list, hparams, alg_name, apply_algo, edit_freq, datatype,test_generation=False):
    current_model = model
    all_metrics = []
    current_training_times = []
    edited_items = []
