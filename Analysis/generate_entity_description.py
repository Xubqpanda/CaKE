...
def main(args):
    ...
    if not args.input_path:
        args.input_path = f"datasets/{args.model_name}/no_shortcut_correct.csv"
    ...
    if not args.output_path:
        args.output_path = f"datasets/{args.model_name}/entity_description/{args.source}_entity_description_s{args.seed}_no_shortcut_correct.csv"
